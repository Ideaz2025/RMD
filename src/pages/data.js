...
const internationalJournals = [
  {
    id: 1,
    authors: "R.Murugadoss, Dr.M.Ramakrishnan",
    title: "Representation of Functions by Sigmoid Function Continuous Mappings Using Multilayer Feed forward Neural Networks",
    journal: "International Journal of Control Theory and Applications",
    publisher: "Serials Publications (India)",
    volume: "Vol.7 No.2",
    year: 2014,
    pages: "63-72",
    issn: "0974-5572"
  },
  {
    id: 2,
    authors: "R.Murugadoss, Dr.M.Ramakrishnan",
    title: "An Effective Performance of Sigmoidal Activation Function in Neural Network Architecture",
  ...
  },
  {
    id: 6,
    authors: "R.Murugadoss, Dr.M.Ramakrishnan",
    title: "Single Hidden Layer Feed Forward Neural Networks for Universal Approximation",
    journal: "International Journal of Advances in Computer, Electrical & Electronics Engineering",
  ...
  },
  {
    id: 7,
    authors: "R.Murugadoss, Dr.M.Ramakrishnan",
    title: "An Artificial Neural Networks approach with NP hardness for efficiency approximation",
...
const books = [
  ...
  {
    id: 2,
    title: "Machine Learning based Neuro-Fuzzy Inference system for identifying and categorizing the stages of Lung Cancer",
    publisher: "Kalaivani Publication",
    isbn: "978-81-954343-9-8",
    authors: [
      "Dr.T.Jayamalar",
      "Dr.R.Murugadoss",
      "Mrs.D S Jayakumari",
  ...
  {
    id: 3,
    title: "A Taxonomy of Privacy issues with VMWARE fusion in Bigdata Analytics Environments",
    publisher: "Kalaivani Publication",
    isbn: "978-81-954343-6-7",
    authors: [
      "Dr.R.Murugadoss",
      "Dr.N.Krishnaveni",
      "M.Rajalakshmi",
...
export { nationalJournals };
export  {internationalJournals};
export { papers };
